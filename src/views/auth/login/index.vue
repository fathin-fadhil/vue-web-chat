    ...
    <div class=" w-full flex flex-col items-center justify-center gap-8">
      ...
      <main class=" p-4 rounded-xl bg-secondary  dark:bg-secondary-dark w-full max-w-lg">
        <form @submit.prevent="login" class=" flex flex-col justify-center gap-4">
          ...
          <div class="relative">
            <input v-model="username" type="text" id="floating_outlined" class="block px-2.5 pb-2.5 pt-2.5 w-full text-base text-gray-900 bg-transparent rounded-lg border-2  border-primary appearance-none dark:text-white dark:border-gray-600 dark:focus:border-teal-500 focus:outline-none focus:ring-1 ring-0 ring-teal-500 focus:border-teal-600 peer" placeholder=" " />
            <label for="floating_outlined" class="absolute text-sm text-gray-500 dark:text-gray-400 transition-all font-semibold transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-secondary dark:bg-secondary-dark px-2 peer-focus:px-2 peer-focus:translate-x-2 translate-x-2 peer-placeholder-shown:translate-x-0 peer-focus:text-teal-600 peer-focus:dark:text-teal-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto start-1">Username</label>
          </div>
